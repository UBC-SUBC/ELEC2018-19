...
*  Last undated May 31, 2019 by Yuki Sekimori
* 
* 
*  Things to add next:
*  1. Sensor 
*  2. IMU
*  3. Control algorithm
*  4. Serial read so that it can change the setup from the serial command.
*/
...
void loop()
{
  ...
  else if (digitalRead(ls1Pin) == 1 && digitalRead(ls2Pin) == 1) {
